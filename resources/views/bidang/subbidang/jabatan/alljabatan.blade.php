...
<li class="breadcrumb-item"><a href="/">Home</a></li>
    ...
    <li class="breadcrumb-item"><a href="/subdepartment">Manajemen Sub-Bidang</a></li>
...
<table id="tabelskp" class="table table-bordered table-striped text-center" style="width:100%">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $jbtn->nama_bidang }}-{{ $jbtn->nama_subbidang }}</td>
                <td>
        ...
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            ...
            <form method="post" action="/employment" >
                @csrf
                <!-- <input type="hidden" name="subbidang_id" id="subbidang_id" value="{{ $jbtn->subbidang_id }}"> -->
                <div class="modal-body">
                    <div class="form-group">
                        <label for="subbidang_id">Pilih Sub-Bidang</label>
                        <select name="subbidang_id" id="subbidang_id" class="form-control select2bs4" style="width: 100%;">
                            @foreach($subbidang as $sbdg)
                                <option value="{{ $sbdg->id }}">{{ $sbdg->nama_bidang }}-{{ $sbdg->nama_subbidang }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="form-group">
